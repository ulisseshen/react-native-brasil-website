# Plano de Tradução - Arquivos Pendentes

**Status:** Em andamento
**Total de arquivos:** 118
**Flag de tradução:** `ia-translated: true`

---

## 📱 APIs Globais (42 arquivos)
...
## 🧩 Componentes e APIs (51 arquivos)
...
Debugging, performance, building e testing:
...
Documentação sobre versionamento e releases:
...
## 🏗️ The New Architecture (1 arquivo)
...
1. **Alta prioridade:** Componentes e APIs principais (accessibility, images, navigation, network, etc.)
2. **Média prioridade:** Guias de debugging e performance
3. **Baixa prioridade:** APIs Globais (são APIs padrão do JavaScript)
4. **Quando necessário:** Legacy e The New Architecture
